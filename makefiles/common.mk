...
common-catalog-render: opm yq generate-catalog-index ## Render bundle to catalog index.
	...
	PATH="$(LOCALBIN):$$PATH" \
	bash $(CATALOG_INDEX_SCRIPT) "$(DOCKER_REPO_BASE)" "$(OPERATOR_NAME)" "$(CATALOG_DIR_PATH)" "$(VERSION)" "$(GIT_TAG)"
